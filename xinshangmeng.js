 ...
 * 验证码：3647
 * 输出：
 * j_mcmm: 4d545bc79efeb40b8c5b4d8216e76713
 */
function B(a) {
...
function o(a) {
  for (
    var b = 1 + ((a.length + 8) >> 6), c = new Array(16 * b), d = 0;
    d < 16 * b;
    d++
  )
    c[d] = 0
  for (var e = 0; e < a.length; e++) c[e >> 2] |= (255 & a[e]) << ((e % 4) * 8)
...
const result = B(B(password) + code)
